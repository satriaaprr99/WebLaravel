			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" href="/corona">
						<span class="nav-link-text text-uppercase text-bold">Covid19 Info</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/berita">
						<span class="nav-link-text text-uppercase text-bold">Berita Terkini</span>
					</a>
				</li>
			</ul>		
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default  dropdown-menu-right ">
						<div class="row shortcuts px-4">
							...
							<a href="/histori" class="col-4 shortcut-item">
