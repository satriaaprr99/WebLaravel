...
<body class="">
    ...
    <div class="sidebar">
      <div class="sidebar-wrapper">
        <div class="logo">
          ...
          <ul class="nav">
            <li class="nav-item">
              <a href="#dropdown" data-toggle="collapse" class="nav-link">
                <i class="tim-icons icon-tv-2"></i>
                <p>Master Data <b class="caret"></b></p>
              </a>
              <div id="dropdown" class="collapse show">
                <ul class="nav">
                  <li class="nav-item">
                    <a href="/datasiswa">
            ...
            <ul class="nav">
            <li class="nav-item">
              <a href="#dropdown1" data-toggle="collapse" class="nav-link">
                <i class="tim-icons icon-money-coins"></i>
                <p>Transaksi <b class="caret"></b></p>
              </a>
              <div id="dropdown1" class="collapse show">
                <ul class="nav">
                  <li class="nav-item">
                    <a href="./dashboard.html">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <div class="photo">
                    <img src="{{asset('assets_admin/img/anime3.png')}}" alt="Profile Photo">
                  </div>
  ...
  <script src="{{asset('assets_admin/perfect-scrollbar.jquery.min.js')}}"></script>
  <!-- Chart JS -->
