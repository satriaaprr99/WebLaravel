<form action="{{ route('angkatan.update', $model['id']) }}" method="PUT">
	...
	<div class="form-group row">
		...
		<div class="col-sm-12 spanerror">
			<input name="nama_angkatan" type="text" class="form-control form-control-sm" id="nama_angkatan" value="{{ $model['nama_angkatan'] }}">
		</div>
	</div>
